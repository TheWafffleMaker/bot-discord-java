...
public class GuildMusicManager {
    public final ShepardTrackScheduler scheduler = new ShepardTrackScheduler(this);
    ...
    public void stop() {
        ...
        this.getPlayer().ifPresent(player -> player.setPaused(false).setTrack(null).subscribe());
    }
